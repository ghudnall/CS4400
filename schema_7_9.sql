...
(item_id INT(2) NOT NULL,
 ...
 FOREIGN KEY(item_id) REFERENCES ITEM(item_id) ON UPDATE CASCADE ON DELETE CASCADE,
 FOREIGN KEY(order_id) REFERENCES TICKET(order_id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY(order_id) REFERENCES TICKET(order_id) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(username) REFERENCES BUYER(username) ON UPDATE CASCADE ON DELETE CASCADE
);
